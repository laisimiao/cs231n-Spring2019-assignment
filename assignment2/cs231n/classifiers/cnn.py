...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        module1_out, module1_cache = conv_relu_pool_forward(X, W1, b1, conv_param, pool_param)
        module2_out, module2_cache = affine_relu_forward(module1_out, W2, b2)
        module3_out, module3_cache = affine_forward(module2_out, W3, b3)
        scores =  module3_out
